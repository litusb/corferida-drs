...
**DOCUMENT DE REFERÈNCIA DEL SISTEMA 1.0 (versió 09 Set. 2025)**

Escriptor del DRS: Rob Hebert | Editor tècnic: Shawn Banerjee

Maquetació: Matt Paquette & Co. | Productors: Dani Gage i Madigan Hunt

Aquest document, inclòs el Marc de campanya de «L’erm marcit» (Witherwild), es considera Public Game Content (Contingut de joc públic) segons la Darrington Press Community Gaming License (Llicència de joc col·lectiva de Darrington Press). Es recomana llegir la Darrington Press Community Gaming License (Llicència de joc col·lectiva de Darrington Press) abans de fer servir el contingut d'aquest document.

© 2025 Critical Role LLC. Tots els drets reservats. Es pot trobar més informació a www.darringtonpress.com/license.

# INTRODUCCIÓ

**Benvinguda a CORFERIDA (Daggerheart),**_ un joc de rol de fantasia cooperatiu ple de màgia extraordinària i de peripècies heroiques emotives._

## QUÈ ÉS AQUEST DOCUMENT?

El Document de referència del sistema (DRS) de Corferida  és un recull dels elements que conformen la mecànica de joc, editat i organitzat d'una manera clara, concisa i fàcil de consultar.

Pots fer servir el manual de joc per:

- consultar ràpidament les regles de Corferida durant les sessions de joc,
- garantir que el material propi s'ajusta al conjunt de regles de Corferida,
- incloure al teu contingut fragments del text que Darrington Press facilita a l'empara de la Darrington Press Community Gaming License (Llicència de joc col·lectiva de Darrington Press) (www.darringtonpress.com/license),
- entendre millor les regles de joc de Corferida, sense el contingut narratiu ni d'ambientació, de manera que les puguis adaptar o modificar per crear material propi.

El DRS de Corferida no substitueix el manual bàsic, que inclou detalls d'ambientació, exemples de regles suplementaris i una gran quantitat de consells útils per jugar a Corferida, així com una maquetació i material gràfic imponents.

En resum, tens a les teves mans el sistema de Corferida reduït a l'essencial: una versió minimalista i ben definida, sense tot el sabor, l'estil i el material complementari que fan tan inspiradora i entretinguda la lectura del manual bàsic. Tant de bo aquest document sigui útil per a la teva taula de joc. Bones aventures!

## ELS FONAMENTS

### QUÈ ÉS CORFERIDA?

Corferida és un joc de rol de taula per a una Directora de joc (DJ) i de 2 a 5 jugadores. Es pot jugar una partida d'una sola sessió (one-shot) o una campanya amb tantes sessions de joc com es vulgui; cada una dura entre 2 i 4 hores.

Durant una sessió de Corferida, la DJ descriu les escenes, narra els esdeveniments i controla els adversaris i els obstacles que els Personatges jugadors (PJs) es troben. Les jugadores, al seu torn, interpreten com reaccionen els seus PJs davant l'escenari que presenta la DJ. Si el resultat de l'acció d'una jugadora depèn de l'atzar o de la fortuna, la DJ demanarà una tirada d'acció.

Quan una jugadora fa una tirada d'acció, fa servir els Daus de dualitat: dos daus de 12 cares (d12) de diferents colors que representen l'Esperança i la Por. Es tiren els Daus de dualitat, se sumen els modificadors pertinents al resultat i es compara el total amb la Dificultat establerta per la DJ. Si el total iguala o supera la Dificultat, la jugadora té èxit; si és menor, falla. A més, la situació varia en funció de quin Dau de dualitat treu el resultat més alt, sigui proporcionant útils punts d'Esperança a la jugadora o generant terrorífics punts de Por per a la DJ.

#### LA REGLA D'OR

La regla més important de Corferida és fer-se propi el joc. Les regles d'aquest DRS s'han dissenyat per ajudar a gaudir de l'experiència a la taula, però cadascú té una manera diferent d’interpretar les regles i d’explicar històries. Les regles no haurien d'interferir mai en la història que es vulgui explicar, en els personatges que es vulguin interpretar o en les aventures que es vulguin viure. Mentre el grup hi estigui d'acord, tot es pot ajustar per adaptar-se a l'estil de joc propi. Si hi ha cap regla que es vulgui ignorar o modificar, no s'ha de dubtar a implementar qualsevol canvi amb el consentiment de la taula.

#### EL RAONAMENT ABANS QUE EL REGLAMENT

La DJ i les jugadores haurien de donar prioritat a les decisions per sobre de les regles quan juguin a Corferida. Aquest document dona resposta a moltes de les preguntes que puguin sorgir sobre el joc, però no les respondrà totes. Quan hi hagi dubtes sobre com aplicar una regla, la DJ ha de prendre una decisió que estigui en sintonia amb la narrativa.

Per exemple, hi ha una arma anomenada garfi que permet arrossegar un objectiu cap a un mateix. La seva descripció no exclou explícitament intentar utilitzar-la per arrossegar tot un castell, però aquest efecte no tindria cap sentit dins de la narrativa. En lloc d’això, la DJ podria decidir que s'arrenquin alguns maons o que l'usuari s'impulsi cap a la paret.

De la mateixa manera, si un personatge fa alguna cosa que lògicament donaria com a resultat una mort immediata, com ara llançar-se dins un volcà actiu sense protecció, és possible que no pugui fer una de les jugades definitives de Corferida, que permeten controlar el destí del personatge en el seu darrer instant. Aquest tipus de conseqüències han de quedar clares abans de completar l'acció i sempre han de seguir la lògica del món.

Corferida és un joc centrat en la narrativa i, per tant, no incentiva les interpretacions tècniques o fora de context de les regles. La DJ té l'autoritat i la responsabilitat de decidir com aplicar-les per reforçar la història: tot ha de fluir cap a la ficció.

# CREACIÓ DE PERSONATGES

Cada jugadora crea el seu PJ mitjançant una sèrie de decisions guiades, o també pot fer servir personatges pregenerats. Algunes d'aquestes decisions són purament narratives (és a dir, només fan aparició dins el joc o l'afecten a través de la interpretació), però altres són eleccions de mecàniques que determinen quines coses pot fer el PJ i en quines accions té més (o menys) probabilitats de tenir èxit al realitzar jugades i accions.

> _**Nota:** pots escriure el nom, els pronoms i la descripció del teu personatge en qualsevol moment del procés de creació._

#### PRIMER PAS

**Escull una Classe i Subclasse.**

Les **Classes** són arquetips de personatge que determinen a quins atributs de classe i **cartes de domini** pot accedir un PJ al llarg de la campanya. En aquest manual hi ha nou classes: Bard, Druida, Fetiller, Guardià, Guerrer, Mag, Muntaner, Murri, Serafí.
...
- **Tria una Subclasse** Les **subclasses** afinen encara més l'arquetip d'una classe i reforcen el seu estil atorgant accés a **habilitats úniques de subclasse**.Cada classe té dues subclasses. Tria una de les subclasses de la teva classe i agafa la seva carta de **Fonaments**.
