...
**DOCUMENT DE REFERÈNCIA DEL SISTEMA 1.0 (ver. 09 Sep 2025)**
...
© 2025 Critical Role LLC. Tots els drets reservats. Per a més informació, visiteu www.darringtonpress.com/license.

# INTRODUCCIÓ

**Benvinguda a CORFERIDA (Daggerheart),** _un joc de rol col·laboratiu i de fantasia ple de màgia increïble i d'autèntiques aventures heroiques._

## Què és això?

El Document de Referència del Sistema (DRS) de Corferida  és un recull dels elements mecànics del sistema Corferida (Daggerheart), editat i organitzat per a una millor claredat, concisió i facilitat de consulta.

Pots fer servir aquest DRS de diverses maneres:

- Per consultar ràpidament les regles oficials de Corferida durant les sessions de joc.
- Per assegurar-te que qualsevol contingut casolà que creïs o publiquis s'ajusta al conjunt de regles de Daggerheart.
- Per utilitzar el text proporcionat per Darrington Press per a les teves pròpies publicacions sota la seva «Llicència de joc comunitari». ([www.darringtonpress.com/license]).
- Per comprendre millor les mecàniques de Corferida sense el contingut narratiu ni d'ambientació, i així poder adaptar-les o modificar-les en crear el teu propi contingut.

El DRS de Corferida no reemplaça el llibre bàsic de regles, que conté informació d'ambientació, exemples addicionals de diverses mecàniques de joc i un munt de consells útils per jugar a Corferida (per no esmentar el seu magnífic art i maquetació).

En resum, això és el sistema de Corferida (Daggerheart) reduït a l'essencial: una versió clara i austera, sense tot el sabor, l'estil i el material complementari que fan del llibre bàsic una lectura tan evocadora i agradable. Esperem que aquest document sigui útil per a la teva taula de joc. Feliç aventura!

## Els fonaments

### Què és Corferida?

Corferida és un joc de rol de taula per a una Directora de Joc (DJ) i de 2 a 5 jugadores. Cada sessió de joc dura entre 2 i 4 hores, i Corferida es pot jugar com una partida d'una sola sessió (one-shot) o una campanya formada per múltiples sessions de la durada que vulgueu.

Durant una sessió de Corferida, la DJ descriu situacions, narra esdeveniments i controla els enemics o els obstacles que els Personatges de les Jugadores (PJs) es troben. Les jugadores, al seu torn, interpreten les reaccions dels seus PJs davant l'escenari presentat per la DJ. Si el resultat de l'acció d'una jugadora depèn de l'atzar o de la fortuna, la DJ demanarà una tirada d'acció.
...
> _**Nota:** pots emplenar el nom, els pronoms i la descripció del teu personatge en qualsevol moment del procés de creació._
